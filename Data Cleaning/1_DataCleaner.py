...
path = "/Users/malika/Documents/Five Lives/SI Data Analysis/LifestyleCognition/Datasets & Data cleaning/oxford 28102022/2022-10-28_questionaire.csv"
Data = pd.read_csv(path)

# Read excluded IDs file
pathIDS = "/Users/malika/Documents/Five Lives/SI Data Analysis/LifestyleCognition/Datasets & Data cleaning/excludedIDs_A0A2.csv"
...
for i in df.columns:
    if i[:2]== 'A0':
        A0.append(i)
df0 = df[A0]
df0.to_csv('/Users/malika/Documents/Five Lives/SI Data Analysis/LifestyleCognition/Datasets & Data cleaning/df0.csv', index=True)
...
for i in df.columns:
    if i[:2]== 'A1':
        A1.append(i)
df1 = df[A1]
df1.to_csv('/Users/malika/Documents/Five Lives/SI Data Analysis/LifestyleCognition/Datasets & Data cleaning/df1.csv', index=True)
...
for i in df.columns:
    if i[:2]== 'A2':
        A2.append(i)
df2 = df[A2]
df2.to_csv('/Users/malika/Documents/Five Lives/SI Data Analysis/LifestyleCognition/Datasets & Data cleaning/df2.csv', index=True)
